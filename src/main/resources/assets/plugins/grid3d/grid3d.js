...
;(function (window) {
    ...
    grid3D.prototype._init = function () {
        ...
        // content
        this.contentEl = this.el.querySelector('div.wall-detail-content');
        // content items
        //this.contentItems = [].slice.call( this.contentEl.children );
        this.contentDetail = this.el.querySelector('#contentDetail');
        // close content cross
        ...
        var self = this,
            loadContent = function () {
                ...
                setTimeout(function () {
                    ...
                    classie.addClass(self.contentDetail, 'show');
                    self.contentDetail.setAttribute('grid-pos', pos);//content添加grid-pos属性
                }, 1000);
                // show content area
    ...
    grid3D.prototype._hideContent = function () {
        var self = this,
            ...
            contentItem = this.contentDetail,
            //currentItem = this.gridItems[ this.contentItems.indexOf( contentItem ) ];
            currentItem = this.gridItems[contentItem.getAttribute('grid-pos')];
